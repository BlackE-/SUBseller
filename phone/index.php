			                ...
			                <?php
			                	...
			                	foreach ($bestSellers as $key => $value) {
			                		...
			                		echo '<div class="boxBorder">';
				                		echo '<div class="thumbContainer"><a href="product?id='.$product['id_product'].'"><img class="bestSellersImg" src="'.$pathImg.$product_img[0]['url'].'"/></a></div>';
