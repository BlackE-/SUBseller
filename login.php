			...
			<div class="container" id="box">
	    		...
	    		<div class="radio-tabs" role="tablist">
	    		    ...
	    		    <div class="tabs" aria-hidden="true">
	    		        <label for="starks" id="starks-tab" class="tab" >REGÍSTRATE</label>
	    		        <label for="lannisters" id="lannisters-tab" class="tab" aria-selected="true">INICIAR SESIÓN</label>
	    		    </div>
	    		    ...
	    		    <div class="panels">
	    		        <ul id="starks-panel" class="panel" role="tabpanel" aria-labelledby="starks-tab">
	    		            ...
	    		            <div class="registerContainer">
	    		            	...
	    		            	<p class="terminos">Recuerda que al hacer una cuenta aceptas nuestros <br><a href="/SMB-TerminosYCondiciones.pdf" target="_BLANK"><i>Términos y condiciones</i></a><br><br>Conoce nuestro <a target="_blank" href="/SMB-AvisoDePrivacidad.pdf">Aviso de privacidad</a></p>
	    		            </div>
	    		        </ul>
